...
<div class="container">
    ...
    <img src="img/sprit2.png" style="width: 100%; height: 720px;">  
		...
		<div class="col-md-8 card shadow" style="background: url(img/r4.jpeg); background-repeat: no-repeat; background-size: cover; height:720px; border-top-right-radius: 25%;border-bottom-left-radius: 15%;">
			<h1 class="text-center icon" style="font-family: 'Lobster', cursive; margin-top: 10px; font-size: 25px;">Admission Form For B.sc</h1>
			<form method="post" action="bsc_insert.php" enctype="multipart/form-data" style="padding: 0px 70px;">
				        <div class="mb-3">

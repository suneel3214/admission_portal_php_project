...
$data = "select * from bcom where id = $id";
...
<div class="container">
    ...
    <img src="img/sprit2.png" style="width: 100%; height: 770px;">  
		...
		<div class="col-md-8 card shadow" style="background: url(img/r4.jpeg); background-repeat: no-repeat; background-size: cover;height:770px; border-top-right-radius: 25%;border-bottom-left-radius: 15%;">
			<h1 class="text-center" style="font-family: 'Lobster', cursive;margin-top: 10px; color: #fff; font-size: 25px;">Admission Form For B.com</h1>
			<form method="post" action="bcom_update.php" enctype="multipart/form-data" style="padding: 0px 70px;">

...
<br><br><br>
              <?php          
                ...
                $email = $_SESSION['e'];
                $data = "select * from bsc where email = '$email'";
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
           ...
           <a href="bsc_edit.php?e=<?php echo $a['id'] ?>" class="btn btn-light" style="background-image: linear-gradient(to right,#295029,#1ed034); width: 100%; color: white;">Edit</a> 
        </div>
    </div>
</div>
</body>
